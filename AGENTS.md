...
- Commit NuGet/npm/Gradle locks and Gradle verification metadata; pin tools/base images/Actions. Dependency updates must pass locked restores and the same image/protocol checks.
